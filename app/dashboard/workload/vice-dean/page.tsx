  ...
  function transformInternalCourses(allCourses: any[]): CourseWorkload[] {
    ...
    allCourses.forEach((course: any) => {
      ...
      assignments.forEach((a: any) => {
        // ✅ เฉพาะ internal เท่านั้นในฟังก์ชันนี้
  ...
  function transformExternalCourses(externalContainers: any[]): CourseWorkload[] {
    ...
    // ✅ externalContainers มาจาก /api/assignments/external
    // แต่ละ container มี teachingAssignments ที่เป็น external ล้วน
    // รองวิชาการเห็นทุก assignment ไม่ต้อง filter ตาม chairId
  ...
  function useWorkloadData() {
    ...
    const fetchData = useCallback(async () => {
      ...
      try {
        ...
        // external ไม่ต้องส่ง chairId เพราะรองวิชาการเห็นทุกอย่าง
        ...
        const internalData = transformInternalCourses(allCourses);
        const externalData = transformExternalCourses(externalCourses);
        const merged = mergeAndSort(internalData, externalData);
